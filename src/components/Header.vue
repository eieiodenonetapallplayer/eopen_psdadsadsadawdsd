<template>
  <header
    class="group sticky top-4 z-30 mb-16 box-content w-full rounded-xl border border-transparent py-3 px-4 transition-all duration-300 hover:shadow-lg sm:rounded-2xl [&.not-top]:border-gray-200/20 [&.not-top]:bg-gray-900/95 dark:[&.not-top]:bg-gray-800/95 backdrop-blur-sm"
  >
    <h1
    ...
    >
      <span class="magic group" @mousemove="updateStarPositions">
        ...
        <span class="magic-text group-hover:animate-text-shimmer" aria-label="COEYONETAP Home"
...
.magic-star > svg {
  ...
  display: block;
  opacity: 0.7;
  fill: var(--star-color, rgb(255, 255, 255));
  filter: drop-shadow(0 0 8px var(--star-color, rgba(255, 255, 255, 0.8)));
}
