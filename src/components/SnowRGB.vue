...
export default {
  props: {
    ...
    swing: { type: Number, default: 2 },
    image: { type: String, default: null },
    zIndex: { type: Number, default: null },
    resize: { type: Boolean, default: true },
    rgbMode: { type: Boolean, default: true },
  ...
  mounted() {
    ...
    let canvasHeight = CANVAS.clientHeight || CANVAS.offsetHeight;
    let canvasWidth = CANVAS.clientWidth || CANVAS.offsetWidth;
    let flakes = [];
      ...
      for (let i = 0; i < self.amount; i++) {
        ...
        if (!self.image) {
          ...
          const currentColor = self.rgbMode ? 
              self.colors[Math.floor(Date.now() / 3000 % self.colors.length)] : 
              self.color;
    ...
    function resizeCanvas() {
      const H0 = CANVAS.height,
            W0 = CANVAS.width,
            H1 = CANVAS.clientHeight || CANVAS.offsetHeight,
            W1 = CANVAS.clientWidth || CANVAS.offsetWidth;
